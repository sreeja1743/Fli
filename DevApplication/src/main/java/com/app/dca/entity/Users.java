...
public class Users {
	...
	public Users(int userId,String userName, String password, boolean loggedIn) {
		super();
		this.userId = userId;
	...
	public String toString() {
		return "Userdeveloper [userId=" + userId + ", userName=" + userName + ", password=" + password + ", loggedIn="
				+ loggedIn + "]";
	}
